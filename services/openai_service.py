...
class LLMService:
    def __init__(self):
        self.chat_openai = ChatOpenAI(api_key=settings.openai_api_key, model="gpt-4o-mini", temperature=0.7,timeout=None, max_retries=2)
    ...
    def chatbot_response(self, messages):
        """
        Streams the response from the LLM as a generator of text chunks.
        """
